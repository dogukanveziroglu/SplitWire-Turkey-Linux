...
def get_backup_manager() -> BackupManager:
    """Get the global BackupManager singleton.

    Returns:
        The shared BackupManager instance.
    """
...
def get_snapshot_manager() -> SnapshotManager:
    """Get the global SnapshotManager singleton.

    Returns:
        The shared SnapshotManager instance.
    """
...
def create_backup(
    ...
    """Create a backup via the global manager.
...
def restore_backup(backup_id: str) -> list[str]:
    """Restore a backup via the global manager.
...
def list_backups(
    ...
    """List backups via the global manager.
